...
-- bc_catalog: Events
-- ============================================================================
INSERT INTO bc_catalog."Events" ("Id", "Name", "Description", "EventDate", "BasePrice", "Venue", "MaxCapacity", "Status", "CreatedAt")
VALUES
  ('11111111-1111-1111-1111-111111111111', 'Concierto Jazz Noche', 'Una noche de jazz contemporáneo con artistas internacionales', NOW() + INTERVAL '7 days', 200000.00, 'Teatro Nacional', 800, 'active', NOW()),
  ('22222222-2222-2222-2222-222222222222', 'Teatro: La Vida es Bella', 'Adaptación teatral de la novela clásica', NOW() + INTERVAL '14 days', 150000.00, 'Centro Cultural', 1200, 'active', NOW()),
  ('33333333-3333-3333-3333-333333333333', 'Match de Fútbol: Local vs Internacional', 'Partido amistoso de clasificación', NOW() + INTERVAL '21 days', 180000.00, 'Estadio Central', 2500, 'active', NOW()),
  ('44444444-4444-4444-4444-444444444444', 'Conferencia Tecnología 2026', 'Charlas sobre tendencias en software', NOW() + INTERVAL '30 days', 120000.00, 'Convention Center', 500, 'active', NOW()),
  ('55555555-5555-5555-5555-555555555555', 'Concierto Rock Nacional', 'Festival con bandas locales e internacionales', NOW() + INTERVAL '45 days', 250000.00, 'Arena Metropolitana', 5000, 'active', NOW());
